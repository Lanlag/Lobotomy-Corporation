...
public class StandardTrainingDummyRabbitEntityModel extends EntityModel<StandardTrainingDummyRabbitEntity> {
    private final ModelPart bb_main;

    public StandardTrainingDummyRabbitEntityModel(ModelPart root) {
    ...
    @Override
    public void setAngles(StandardTrainingDummyRabbitEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
