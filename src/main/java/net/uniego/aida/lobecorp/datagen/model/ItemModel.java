...
public class ItemModel extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        itemModelGenerator.register(EGOSuit.BEAR_PAWS_SUIT, Models.GENERATED);
        itemModelGenerator.register(EGOSuit.JUSTITIA_SUIT, Models.GENERATED);
        ...
        itemModelGenerator.register(BearPawsGift.BEAR_PAWS_GIFT, Models.GENERATED);
        itemModelGenerator.register(JustitiaGift.JUSTITIA_GIFT, Models.GENERATED);
        ...
        itemModelGenerator.register(AbnormalitySpawnEgg.JUDGEMENT_BIRD_EGG, Models.GENERATED);
    }
}
