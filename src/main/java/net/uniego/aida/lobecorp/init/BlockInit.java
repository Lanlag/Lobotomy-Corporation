...
public class BlockInit {
    ...
    public static final Block QLIPHOTH_COUNTER = register("qliphoth_counter", new QliphothCounterBlock(AbstractBlock.Settings.create().mapColor(MapColor.YELLOW).strength(-1F, -1F).luminance(state -> 12)));
    ...
    public static final Block DARK_CONCRETE_WALL = register("dark_concrete_wall", new Block(AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_GRAY).strength(-1F, -1F)));
    public static final Block ROOF_DARK_CONCRETE_WALL = register("roof_dark_concrete_wall", new RoofBlock(AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_GRAY).strength(-1F, -1F)));
